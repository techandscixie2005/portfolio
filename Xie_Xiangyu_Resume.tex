...
{\small Independent Developer\enspace |\enspace Completed competition prototype}\par
{\small\textbf{Second Prize, Graduate Division} $\cdot$ Agent Track, USTC ``107 Cup'' (Sep 2026) --- Solo entrant.}
\begin{itemize}
